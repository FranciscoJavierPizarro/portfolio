    ...
    const experience2022 = [
        {
            ...
            `En palabras de mi mentor cuando este periodo llego a su fin: “Eres muy bueno llegando a una solución para el core de la tarea y tomando una aproximación creativa para resolver los problemas que surgen"`],
    ...
    const experience2023 = [
        {
            ...
            "Dicho trabajo se constituye de 300 horas de trabajo, a la hora de elegir entre las distintas opciones tendré en cuenta factores muy relevantes como el tema sobre el cual realizar el TFG, la experiencia de la empresa elegida con TFGs anteriores, así como las condiciones ofrecidas para desarrollar el mismo."],
            link: "",
            img:  ""
        },
    ]
